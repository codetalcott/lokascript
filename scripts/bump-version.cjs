...
console.log('   ⚠️  See docs-internal/build/CHANGELOG_GUIDELINES.md for details');
...
console.log(`     ⚠️  Only include changes to PUBLIC packages (see docs-internal/build/CHANGELOG_GUIDELINES.md)`);
