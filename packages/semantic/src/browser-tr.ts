/**
 * Turkish Browser Bundle Entry Point
 *
 * Minimal single-language bundle.
 * Estimated size: ~68 KB
 *
 * @example
 * ```html
 * <script src="hyperfixi-semantic.tr.global.js"></script>
 * <script>
 *   const ast = HyperFixiSemanticTr.parse('toggle .active', 'tr');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: tr
// =============================================================================
...
const SUPPORTED_LANGUAGES = ['tr'] as const;
