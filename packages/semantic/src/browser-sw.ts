/**
 * Swahili Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.sw.global.js"></script>
 * <script>
 *   const ast = LokaScriptSemanticSw.parse('toggle .active', 'sw');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: sw
// =============================================================================
...
export const VERSION = '1.0.0-sw';

// =============================================================================
// Supported Languages
// =============================================================================

const SUPPORTED_LANGUAGES = ['sw'] as const;
...
function validateLanguage(language: string): void {
  if (language !== 'sw') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: sw`);
  }
}
...
export { swahiliProfile } from './generators/language-profiles';
