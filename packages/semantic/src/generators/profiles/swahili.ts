...
export const swahiliProfile: LanguageProfile = {
  ...
  keywords: {
    ...
    set: { primary: 'seti', alternatives: ['weka'], normalized: 'set' },
    get: { primary: 'pata', alternatives: ['pokea'], normalized: 'get' },
    increment: { primary: 'ongezeko', alternatives: ['ongeza'], normalized: 'increment' },
