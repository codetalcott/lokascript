...
export const russianProfile: LanguageProfile = {
  ...
  keywords: {
    ...
    toggle: { primary: 'переключить', alternatives: ['переключи'], normalized: 'toggle', form: 'infinitive' },
    add: { primary: 'добавить', alternatives: ['добавь'], normalized: 'add', form: 'infinitive' },
    remove: { primary: 'удалить', alternatives: ['удали', 'убрать', 'убери'], normalized: 'remove', form: 'infinitive' },
    // Content operations
    put: { primary: 'положить', alternatives: ['положи', 'поместить', 'помести', 'вставить', 'вставь'], normalized: 'put', form: 'infinitive' },
    append: { primary: 'добавить_в_конец', alternatives: ['дописать'], normalized: 'append', form: 'infinitive' },
    ...
    clone: { primary: 'клонировать', alternatives: ['клонируй'], normalized: 'clone', form: 'infinitive' },
    swap: { primary: 'поменять', alternatives: ['поменяй'], normalized: 'swap', form: 'infinitive' },
    morph: { primary: 'трансформировать', alternatives: ['трансформируй'], normalized: 'morph', form: 'infinitive' },
    // Variable operations
    set: { primary: 'установить', alternatives: ['установи', 'задать', 'задай'], normalized: 'set', form: 'infinitive' },
    get: { primary: 'получить', alternatives: ['получи'], normalized: 'get', form: 'infinitive' },
    increment: { primary: 'увеличить', alternatives: ['увеличь'], normalized: 'increment', form: 'infinitive' },
    decrement: { primary: 'уменьшить', alternatives: ['уменьши'], normalized: 'decrement', form: 'infinitive' },
    ...
    hide: { primary: 'скрыть', alternatives: ['скрой', 'спрятать', 'спрячь'], normalized: 'hide', form: 'infinitive' },
    transition: { primary: 'анимировать', alternatives: ['анимируй'], normalized: 'transition', form: 'infinitive' },
    // Events
    on: { primary: 'при', alternatives: ['когда'], normalized: 'on' },
    trigger: { primary: 'вызвать', alternatives: ['вызови'], normalized: 'trigger', form: 'infinitive' },
    send: { primary: 'отправить', alternatives: ['отправь'], normalized: 'send', form: 'infinitive' },
    // DOM focus
    focus: { primary: 'сфокусировать', alternatives: ['сфокусируй', 'фокус'], normalized: 'focus', form: 'infinitive' },
    blur: { primary: 'размыть', alternatives: ['размой'], normalized: 'blur', form: 'infinitive' },
    // Navigation
    go: { primary: 'перейти', alternatives: ['перейди', 'идти', 'иди'], normalized: 'go', form: 'infinitive' },
    // Async
    wait: { primary: 'ждать', alternatives: ['жди', 'подожди'], normalized: 'wait', form: 'infinitive' },
    fetch: { primary: 'загрузить', alternatives: ['загрузи'], normalized: 'fetch', form: 'infinitive' },
    ...
    continue: { primary: 'продолжить', alternatives: ['продолжи'], normalized: 'continue', form: 'infinitive' },
    halt: { primary: 'остановить', alternatives: ['остановись', 'стоп'], normalized: 'halt', form: 'infinitive' },
    ...
    return: { primary: 'вернуть', alternatives: ['верни'], normalized: 'return', form: 'infinitive' },
    ...
    init: { primary: 'инициализировать', alternatives: ['инициализируй'], normalized: 'init', form: 'infinitive' },
    behavior: { primary: 'поведение', normalized: 'behavior' },
    install: { primary: 'установить_пакет', normalized: 'install', form: 'infinitive' },
    measure: { primary: 'измерить', alternatives: ['измерь'], normalized: 'measure', form: 'infinitive' },
    // Modifiers
