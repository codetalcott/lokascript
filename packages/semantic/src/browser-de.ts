/**
 * German Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="hyperfixi-semantic.de.global.js"></script>
 * <script>
 *   const ast = LokaScriptSemanticDe.parse('toggle .active', 'de');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: de
// =============================================================================
...
function validateLanguage(language: string): void {
  if (language !== 'de') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: de`);
  }
}
...
export { germanProfile } from './generators/language-profiles';
