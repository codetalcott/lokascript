...
export const SUPPORTED_LANGUAGES: LanguageChecklist[] = [
  ...
  },
  {
    ...
    morphology: {
      ...
      inflectionTypes: ['-are conjugations', '-ere conjugations', '-ire conjugations', 'reflexive verbs'],
      integratedWithTokenizer: true,
      confidenceThreshold: 0.7,
    },
    profileKeywords: [
      'commutare', 'aggiungere', 'rimuovere', 'mettere', 'impostare',
      'mostrare', 'nascondere', 'incrementare', 'decrementare',
    ],
    tokenizerKeywords: [
      'commutare', 'alternare', 'toggle',
      'aggiungere', 'rimuovere', 'eliminare',
      'mettere', 'impostare', 'ottenere',
      'mostrare', 'nascondere',
  ...
  },
  {
    ...
    profileKeywords: [
      'chuyển đổi', 'thêm', 'xóa', 'đặt', 'gán',
      'hiển thị', 'ẩn', 'tăng', 'giảm',
    ],
    tokenizerKeywords: [
      'chuyển đổi', 'bật tắt',
      'thêm', 'xóa', 'gỡ bỏ',
  ...
  },
  {
    ...
    profileKeywords: [
      'przełącz', 'dodaj', 'usuń', 'umieść', 'ustaw',
      'pokaż', 'ukryj', 'zwiększ', 'zmniejsz',
    ],
    tokenizerKeywords: [
      'przełącz', 'przelacz',
      'dodaj', 'usuń', 'usun',
  ...
  },
  {
    ...
    morphology: {
      needed: true,
      reason: 'Russian is fusional with verb conjugations; uses infinitive or imperative form for commands',
      inflectionTypes: ['infinitive form', 'imperative form', 'present tense', 'past tense'],
      integratedWithTokenizer: false,
      confidenceThreshold: 0.7,
    },
    profileKeywords: [
      'переключить', 'добавить', 'удалить', 'положить', 'установить',
      'показать', 'скрыть', 'увеличить', 'уменьшить',
    ],
    tokenizerKeywords: [
      'переключить', 'переключи',
      'добавить', 'добавь', 'удалить', 'удали',
      'положить', 'положи', 'установить', 'установи',
      'показать', 'покажи', 'скрыть', 'скрой',
      'увеличить', 'увеличь', 'уменьшить', 'уменьши',
    ],
    missingFromTokenizer: [],
    potentialConflicts: [],
  },
  {
    ...
    morphology: {
      needed: true,
      reason: 'Ukrainian is fusional with verb conjugations; uses infinitive or imperative form for commands',
      inflectionTypes: ['infinitive form', 'imperative form', 'present tense', 'past tense'],
      integratedWithTokenizer: false,
      confidenceThreshold: 0.7,
    },
    profileKeywords: [
      'перемкнути', 'додати', 'видалити', 'покласти', 'встановити',
      'показати', 'сховати', 'збільшити', 'зменшити',
    ],
    tokenizerKeywords: [
      'перемкнути', 'перемкни',
      'додати', 'додай', 'видалити', 'видали',
      'покласти', 'поклади', 'встановити', 'встанови',
      'показати', 'покажи', 'сховати', 'сховай',
      'збільшити', 'збільш', 'зменшити', 'зменш',
    ],
    missingFromTokenizer: [],
    potentialConflicts: [],
  },
  {
    ...
    profileKeywords: [
      'टॉगल', 'जोड़ें', 'हटाएं', 'रखें', 'सेट',
      'दिखाएं', 'छिपाएं', 'बढ़ाएं', 'घटाएं',
    ],
    tokenizerKeywords: [
      'टॉगल', 'बदलें',
      'जोड़ें', 'जोड़', 'हटाएं', 'हटा',
      'रखें', 'रख', 'सेट', 'निर्धारित',
      'दिखाएं', 'दिखा', 'छिपाएं', 'छिपा',
      'बढ़ाएं', 'बढ़ा', 'घटाएं', 'घटा',
    ],
    missingFromTokenizer: [],
    potentialConflicts: [],
  },
  {
    ...
    profileKeywords: [
      'টগল', 'যোগ', 'সরান', 'রাখুন', 'সেট',
      'দেখান', 'লুকান', 'বৃদ্ধি', 'হ্রাস',
    ],
    tokenizerKeywords: [
      'টগল', 'পরিবর্তন',
      'যোগ', 'সরান', 'মুছুন',
      'রাখুন', 'রাখ', 'সেট', 'নির্ধারণ',
      'দেখান', 'দেখাও', 'লুকান', 'লুকাও',
      'বৃদ্ধি', 'বাড়ান', 'হ্রাস', 'কমান',
    ],
    missingFromTokenizer: [],
    potentialConflicts: [],
  },
  {
    ...
    profileKeywords: [
      'สลับ', 'เพิ่ม', 'ลบ', 'ใส่', 'ตั้ง',
      'แสดง', 'ซ่อน', 'เพิ่มค่า', 'ลดค่า',
    ],
    tokenizerKeywords: [
      'สลับ', 'เปลี่ยน',
      'เพิ่ม', 'ลบ', 'ลบออก',
