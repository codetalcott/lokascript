/**
 * French Browser Bundle Entry Point
 *
 ...
 * @example
 * ```html
 * <script src="lokascript-semantic.fr.global.js"></script>
 * <script>
 *   const ast = LokaScriptSemanticFr.parse('toggle .active', 'fr');
 * </script>
 * ```
 */

// =============================================================================
// Register Languages: fr
// =============================================================================
...
function validateLanguage(language: string): void {
  if (language !== 'fr') {
    throw new Error(`Language not supported in this bundle: ${language}. ` + `Supported: fr`);
  }
}
...
export { frenchProfile } from './generators/language-profiles';
