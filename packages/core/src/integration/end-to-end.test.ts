...
describe('End-to-End Hyperscript Integration', () => {
  ...
  describe('Error Handling Integration', () => {
    it('should handle missing context element gracefully', async () => {
      ...
      await expect(
        hyperscript.run('hide me', context)
      ).rejects.toThrow('Context element "me" is null');
    });
    ...
    it('should handle invalid syntax gracefully', async () => {
      ...
      await expect(
        hyperscript.run('invalidCommand me', context)
    ...
    it('should handle compilation errors gracefully', async () => {
      ...
      // Try invalid syntax
      await expect(
        hyperscript.run('invalid @@ syntax', context)
      ).rejects.toThrow('Compilation failed');
    });
