...
describe('Enhanced Special Expressions', () => {
  ...
  describe('Expression Registry', () => {
    it('should export all enhanced special expressions', () => {
      expect(enhancedSpecialExpressions.stringLiteral).toBeInstanceOf(EnhancedStringLiteralExpression);
      expect(enhancedSpecialExpressions.numberLiteral).toBeInstanceOf(EnhancedNumberLiteralExpression);
      expect(enhancedSpecialExpressions.booleanLiteral).toBeInstanceOf(EnhancedBooleanLiteralExpression);
    ...
    it('should have consistent metadata across all expressions', () => {
      Object.values(enhancedSpecialExpressions).forEach(expression => {
        expect(expression.category).toBe('Special');
