...
describe('Enhanced Reference Expressions', () => {
  ...
  describe('Expression Registry', () => {
    it('should export all enhanced reference expressions', () => {
      expect(enhancedReferenceExpressions.me).toBeInstanceOf(EnhancedMeExpression);
      expect(enhancedReferenceExpressions.you).toBeInstanceOf(EnhancedYouExpression);
      expect(enhancedReferenceExpressions.it).toBeInstanceOf(EnhancedItExpression);
      expect(enhancedReferenceExpressions['css-selector']).toBeInstanceOf(EnhancedCSSSelectorExpression);
    });
  ...
  describe('Integration with Existing System', () => {
    it('should maintain backward compatibility with current expression interface', () => {
      ...
      const meExpr = enhancedReferenceExpressions.me;
  ...
  describe('Error Handling', () => {
    it('should handle evaluation errors gracefully', async () => {
      const selectorExpr = enhancedReferenceExpressions['css-selector'];
  ...
  describe('Performance Characteristics', () => {
    ...
    it('should track evaluation metrics', async () => {
      const itExpr = enhancedReferenceExpressions.it;
