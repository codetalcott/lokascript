...
describe('Enhanced Comparison Expressions Integration', () => {
  ...
  describe('Expression registry', () => {
    it('should provide all comparison expressions', () => {
      ...
      expect(enhancedComparisonExpressions.equals).toBeInstanceOf(EnhancedEqualityExpression);
      expect(enhancedComparisonExpressions.notEquals).toBeInstanceOf(EnhancedInequalityExpression);
    });
  });
  ...
  describe('Comparison chains', () => {
    it('should handle multiple comparisons', async () => {
      ...
      const lessThan = enhancedComparisonExpressions.lessThan;
      const greaterThan = enhancedComparisonExpressions.greaterThan;
  ...
  describe('Range validation', () => {
    it('should validate value is within range', async () => {
      ...
      const greaterOrEqual = enhancedComparisonExpressions.greaterThanOrEqual;
      const lessOrEqual = enhancedComparisonExpressions.lessThanOrEqual;
  ...
  describe('Type safety', () => {
    it('should have consistent metadata', () => {
      const expressions = Object.values(enhancedComparisonExpressions);
  ...
  describe('Real-world scenarios', () => {
    ...
    it('should handle status checks', async () => {
      const equals = enhancedComparisonExpressions.equals;
      const notEquals = enhancedComparisonExpressions.notEquals;
