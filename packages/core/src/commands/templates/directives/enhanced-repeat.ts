...
export class EnhancedRepeatDirective implements EnhancedTemplateDirective<RepeatDirectiveInput, string> {
  ...
  public readonly documentation: TemplateLLMDocumentation = {
    summary: 'Iterates over a collection and renders template content for each item with scoped context',
    parameters: [
      {
        name: 'collection',
        type: 'object',
    ...
    patterns: [
      {
        name: 'Table Rows',
        template: '<table>\n@repeat in data\n<tr>\n  <td>${it.id}</td>\n  <td>${it.name}</td>\n  <td>${it.value}</td>\n</tr>\n@end\n</table>',
        context: { data: [{ id: 1, name: 'Item 1', value: 100 }, { id: 2, name: 'Item 2', value: 200 }] },
      ...
      },
      {
        ...
        expectedOutput: '<div class="card-grid">\n<div class="card">\n  <img src="widget.jpg" alt="Widget">\n  <h3>Widget</h3>\n  <p class="price">$29.99</p>\n</div>\n</div>',
