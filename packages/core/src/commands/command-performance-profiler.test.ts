...
describe('CommandPerformanceProfiler', () => {
  ...
  beforeEach(() => {
    ...
    mockContext = {
      ...
      it: null,
      result: null,
      locals: new Map([['var1', 'value1'], ['var2', 'value2']]),
      globals: new Map(),
      parent: null,
      halted: false,
      returned: false,
  ...
  describe('Performance Statistics', () => {
    ...
    it('should calculate basic statistics', () => {
      ...
      executionTimes.forEach((time, i) => {
        const profileId = profiler.startProfiling('set', [`x${i}`, 'to', i.toString()], mockContext);
        mockTime = time;
  ...
  describe('Bottleneck Identification', () => {
    ...
    it('should identify high variance bottleneck', () => {
      ...
      const varianceBottleneck = bottlenecks.find(b => b.issue.includes('High performance variance'));
