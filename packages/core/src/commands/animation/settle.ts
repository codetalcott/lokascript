...
> {
  metadata = {
    name: 'settle',
    description: 'The settle command waits for CSS transitions and animations to complete on the target element. It monitors animation and transition events to determine when the element has settled.',
    examples: [
      'settle',
