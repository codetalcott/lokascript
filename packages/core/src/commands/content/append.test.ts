...
describe('Append Command', () => {
  ...
  describe('Command Properties', () => {
    it('should have correct metadata', () => {
      ...
      expect(command.description).toBe('The append command adds a string value to the end of another string, array, or HTML Element. If no target variable is defined, then the standard result variable is used by default.');
    });
  });
